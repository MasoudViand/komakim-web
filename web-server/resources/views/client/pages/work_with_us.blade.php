...
@section('content')
    ...
    @endif
    <div class="row work">
	<h1>همکاری با کمکیم </h1>
	<p class="text-success">
	همکاری با کمکیم بسیار ساده است،کافیست در فرم زیر اطلاعات و مشخصات خودتان با نوع فعایت و مهارتی که در آن تخصص دارید را وارد کرده، تا در اسرع وقت کارشناسان ما جهت مصاحبه حضوری با شما تماس بگیرند.
