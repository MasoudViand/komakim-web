    ...
    <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('admin.category.update.submit') }}">
        ...
        <div id="subform" class="box-body">
            ...
            <div class="form-group">
                ...
                <input  class="form-control" id="nameCategory" name="nameCategory" value="{{$category->name}}">
            ...
            <input  class="form-control" type="hidden" id="idCategory" name="idCategory" value="{{$category->id}}">
            ...
            <div class="form-group">
                ...
                <input type="" class="form-control" name="orderCategory" id="orderCategory" value="{{$category->order}}">
