        ...
        <div class="box-body pad">
            <form method="post" action="{{route('admin.edit.email.template.submit')}}">
                ...
                <div class="form-group" style="width:350px">
                    ...
                    <input  class="form-control" id="nameEmailTemplate" name="nameEmailTemplate" value="{{$mailTemplate->name}}" >
                ...
                <textarea  id="Template" name="Template" class="textarea" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$mailTemplate->html_email_template}}</textarea>
