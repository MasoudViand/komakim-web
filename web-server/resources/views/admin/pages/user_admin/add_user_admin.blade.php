...
@section('content')
    ...
    <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('admin.user_admin.insert.submit') }}">
        {{ csrf_field() }}
        <div id="subform" class="box-body">
            ...
            <div class="form-group">
                ...
                <input  class="form-control" id="username" name="username" placeholder="نام کاربر ">
